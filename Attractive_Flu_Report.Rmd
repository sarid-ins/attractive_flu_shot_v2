...
We examine the two-way ANOVA with vaccination intention as the dependent variable versus treatment and certainty. We are using a dichotomous variable certain/uncertain (where uncertain = certainty<=3).
...
We also test one-way ANOVA of the vaccination intention versus treatment type (for each certainty type, seperately).
...
## Multiple comparisons using Dunnettes test (for uncertain only)
...
## One-way ANOVA and Dunnette for the entire population
