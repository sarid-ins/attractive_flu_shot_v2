...
## Ordinal regression of vaccination intentions versus treatments

```{r ordinal regression intentions}
...
intentions_olr <- MASS::polr(data = flu_olr, 
                             formula = action_recoded ~ treatment)
intentions_olr
```
